...
const baseUrl = process.env.EMAIL_URL
  ? `https://${process.env.VERCEL_URL}`
  : "";

const PropDefaults: WelcomeTemplateProps = {
  tips: [
    {
      id: 1,
      description:
...
export const WelcomeTemplate = ({ tips = [] }: WelcomeTemplateProps) => (
  <Html>
    <Head />
      ...
      <Container style={container}>
          ...
          <Row>
            <Column style={headerContent}>
              <Heading style={headerContentTitle}>
                Record all maintenance activities you carry with nazux-cmms
              </Heading>
              <Text style={headerContentSubtitle}>What we do at nazux</Text>
            </Column>
        ...
        <Section style={content}>
          ...
          <Section style={buttonContainer}>
            <Link style={button} href="https://nazux.blog/2019/10/22/">
              I need a break
            </Link>
          </Section>
        </Section>
...
const headerContent: CSSProperties = { padding: "20px 30px 15px" };
